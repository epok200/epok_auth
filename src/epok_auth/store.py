...
class AuthTransaction(Protocol):
    ...
    async def get_user_by_email(self, email: str, *, for_update: bool = False) -> UserAccount | None: ...
    async def get_user_by_id(self, user_id: UUID, *, for_update: bool = False) -> UserAccount | None: ...
    ...
    async def get_session_by_token_hash(self, token_hash: str, *, for_update: bool = False) -> RefreshSession | None: ...
